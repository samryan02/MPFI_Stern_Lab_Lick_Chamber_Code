...
The circutry is run on a  arduino mega using 10 interupt channels triggered by a voltage splitter circut whos output is run throught a lowpass filter for debouncing. Ardunio code is interupt based and is designed to run on an arduino mega with a serial speed of 9600.
...
This code will automaticly Identify the all arduinos plugged into the deivce However you will have to use the Graphical user interface to name the data file which will be output for each arduino.
